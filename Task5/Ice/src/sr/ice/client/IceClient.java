...
public class IceClient 
{
	public static void main(String[] args) 
	{
		...
		try {
			...
			//ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000  : udp -h 127.0.0.2 -p 10000 "); //opcja -z w³¹za **mo¿liwoœæ** kompresji
			//ObjectPrx base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.2 -p 10000  : udp -h 127.0.0.2 -p 10000 "); //opcja -z w³¹za **mo¿liwoœæ** kompresji
			...
			do	{
				try	{
					...
					{
						float r = obj1.avg(new long[]{1, 2, 3, 4, 10});
						System.out.println("RESULT = " + r);
					}
