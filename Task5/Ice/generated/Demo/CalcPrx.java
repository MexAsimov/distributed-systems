...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(long[] a)
        throws NoElements
    {
        return avg(a, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] a, java.util.Map<String, String> context)
        throws NoElements
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] a)
    {
        return _iceI_avgAsync(a, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] a, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_a, java.util.Map<String, String> context, boolean sync)
    {
