...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticNOpArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultipleNMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MultipleN",
      requestType = sr.grpc.gen.ArithmeticNOpArguments.class,
      responseType = sr.grpc.gen.ArithmeticOpResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticNOpArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultipleNMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticNOpArguments, sr.grpc.gen.ArithmeticOpResult> getMultipleNMethod;
    if ((getMultipleNMethod = CalculatorGrpc.getMultipleNMethod) == null) {
      synchronized (CalculatorGrpc.class) {
        if ((getMultipleNMethod = CalculatorGrpc.getMultipleNMethod) == null) {
          CalculatorGrpc.getMultipleNMethod = getMultipleNMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.ArithmeticNOpArguments, sr.grpc.gen.ArithmeticOpResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MultipleN"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.ArithmeticNOpArguments.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.ArithmeticOpResult.getDefaultInstance()))
              .setSchemaDescriptor(new CalculatorMethodDescriptorSupplier("MultipleN"))
              .build();
        }
      }
    }
    return getMultipleNMethod;
  }
  ...
  public static abstract class CalculatorImplBase implements io.grpc.BindableService {
    ...
    public void multipleN(sr.grpc.gen.ArithmeticNOpArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMultipleNMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sr.grpc.gen.ArithmeticNOpArguments,
                sr.grpc.gen.ArithmeticOpResult>(
                  this, METHODID_MULTIPLE_N)))
          .build();
    }
  }
  ...
  public static final class CalculatorStub extends io.grpc.stub.AbstractAsyncStub<CalculatorStub> {
    ...
    public void multipleN(sr.grpc.gen.ArithmeticNOpArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getMultipleNMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CalculatorBlockingStub extends io.grpc.stub.AbstractBlockingStub<CalculatorBlockingStub> {
    ...
    /**
     */
    public sr.grpc.gen.ArithmeticOpResult multipleN(sr.grpc.gen.ArithmeticNOpArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getMultipleNMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CalculatorFutureStub extends io.grpc.stub.AbstractFutureStub<CalculatorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.ArithmeticOpResult> multipleN(
        sr.grpc.gen.ArithmeticNOpArguments request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getMultipleNMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_ADD = 0;
  private static final int METHODID_SUBTRACT = 1;
  private static final int METHODID_MULTIPLE_N = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_SUBTRACT:
          serviceImpl.subtract((sr.grpc.gen.ArithmeticOpArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult>) responseObserver);
          break;
        case METHODID_MULTIPLE_N:
          serviceImpl.multipleN((sr.grpc.gen.ArithmeticNOpArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult>) responseObserver);
          break;
        default:
