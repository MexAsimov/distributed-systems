...
{
    default PTZCameraInfo getPTZCameraInfo()
    {
        return getPTZCameraInfo(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default PTZCameraInfo getPTZCameraInfo(java.util.Map<String, String> context)
    {
        return _iceI_getPTZCameraInfoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<PTZCameraInfo> getPTZCameraInfoAsync()
    {
        return _iceI_getPTZCameraInfoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<PTZCameraInfo> getPTZCameraInfoAsync(java.util.Map<String, String> context)
    {
        return _iceI_getPTZCameraInfoAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<PTZCameraInfo> _iceI_getPTZCameraInfoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<PTZCameraInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getPTZCameraInfo", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     PTZCameraInfo ret;
                     ret = PTZCameraInfo.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default void changeCameraPosition(CameraPosition position)
        throws DeviceOff,
               OutOfRangeValue
    {
        changeCameraPosition(position, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void changeCameraPosition(CameraPosition position, java.util.Map<String, String> context)
        throws DeviceOff,
               OutOfRangeValue
    {
        try
        {
            _iceI_changeCameraPositionAsync(position, context, true).waitForResponseOrUserEx();
        }
        catch(DeviceOff ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Void> changeCameraPositionAsync(CameraPosition position)
    {
        return _iceI_changeCameraPositionAsync(position, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> changeCameraPositionAsync(CameraPosition position, java.util.Map<String, String> context)
    {
        return _iceI_changeCameraPositionAsync(position, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_changeCameraPositionAsync(CameraPosition iceP_position, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "changeCameraPosition", null, sync, _iceE_changeCameraPosition);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_changeCameraPosition =
    {
        DeviceOff.class,
        OutOfRangeValue.class
    };

    default void setCameraPosition(CameraPosition position)
        throws DeviceOff,
               OutOfRangeValue
    {
        setCameraPosition(position, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setCameraPosition(CameraPosition position, java.util.Map<String, String> context)
        throws DeviceOff,
               OutOfRangeValue
    {
        try
        {
            _iceI_setCameraPositionAsync(position, context, true).waitForResponseOrUserEx();
        }
        catch(DeviceOff ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Void> setCameraPositionAsync(CameraPosition position)
    {
        return _iceI_setCameraPositionAsync(position, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setCameraPositionAsync(CameraPosition position, java.util.Map<String, String> context)
    {
        return _iceI_setCameraPositionAsync(position, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setCameraPositionAsync(CameraPosition iceP_position, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setCameraPosition", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setCameraPosition);
        f.invoke(true, context, null, ostr -> {
                     CameraPosition.ice_write(ostr, iceP_position);
                 }, null);
        return f;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_setCameraPosition =
    {
        DeviceOff.class,
        OutOfRangeValue.class
    };
