...
public interface CameraPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getCameraInfo(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CameraInfo getCameraInfo(java.util.Map<String, String> context)
    {
        return _iceI_getCameraInfoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<CameraInfo> getCameraInfoAsync()
    {
        return _iceI_getCameraInfoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CameraInfo> getCameraInfoAsync(java.util.Map<String, String> context)
    {
        return _iceI_getCameraInfoAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<CameraInfo> _iceI_getCameraInfoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<CameraInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getCameraInfo", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    default void setState(State state, java.util.Map<String, String> context)
    {
        _iceI_setStateAsync(state, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setStateAsync(State state)
    {
        return _iceI_setStateAsync(state, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setStateAsync(State state, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setStateAsync(State iceP_state, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setState", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    default void setNightVisionState(State state)
        throws DeviceOff
    {
        setNightVisionState(state, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setNightVisionState(State state, java.util.Map<String, String> context)
        throws DeviceOff
    {
        try
        {
            _iceI_setNightVisionStateAsync(state, context, true).waitForResponseOrUserEx();
        }
        catch(DeviceOff ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<Void> setNightVisionStateAsync(State state)
    {
        return _iceI_setNightVisionStateAsync(state, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setNightVisionStateAsync(State state, java.util.Map<String, String> context)
    {
        return _iceI_setNightVisionStateAsync(state, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setNightVisionStateAsync(State iceP_state, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setNightVisionState", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setNightVisionState);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_setNightVisionState =
    {
        DeviceOff.class
    };
